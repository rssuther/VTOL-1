        ...
        while (self.FRAME_COUNTER < MAX_PHOTO_COUNT):
            ...
            if visualize:
                ...
                if (SHOW_VIS_OUTPUT):
                    ...
                    cv2.moveWindow('IMAGE STITCHING', 150, 172)
                    cv2.imshow('IMAGE STITCHING', visualization)
                    cv2.waitKey(1050)
            ...
            if (SHOW_VIS_OUTPUT):
                ...
                cv2.moveWindow('IMAGE STITCHING', 150, 172)
                cv2.imshow('IMAGE STITCHING', current_stitched_area)
                cv2.waitKey(1050)
...
#    print('Exiting Stitching Process\n')
#    exit(1)

def img_stitching_demo(show_vis=None):
#def main():
